...
const ClientesRegistrados = () => {
  ...
  const eliminarMateria = async (id) => {
    const result = await Swal.fire({
      title: '¿Estás seguro?',
      text: "No podrás encontrar este usuario después de eliminarlo.",
      icon: 'warning',
  ...
  const editarMateria = (materia) => {
    navigate(`/editar-cliente/${materia._id}`, { state: { materia } }); // Navegar a la página de edición
  };
  ...
  return (
    <div className="contenedor-materias">
      ...
      <h2 className="titulo">Clientes Registradas</h2>
