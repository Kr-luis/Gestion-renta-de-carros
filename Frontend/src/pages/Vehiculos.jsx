...
const Vehiculos = () => {
  ...
  const handleVerEstudiantes = () => {
    navigate('/vehiculos'); // Navega a la página de estudiantes registrados
  };

  return (
    <div className="contenedor-estudiantes">
      <h2 className="titulo">Registrar Vehiculo</h2>
      <form onSubmit={crearEstudiante} className="formulario">
        ...
        <div className="botones">
          ...
          <button type="button" onClick={handleVerEstudiantes} className="boton-secundario">Vehículos Registrados</button>
        </div>
      </form>
    </div>
  );
